...
Lambert scout/postprocess once per useful origin body, then pass all JSONL files:
  ...
  python mga_beam_search_v0_2.py \
...
SCHEMA_VERSION = "mga_beam_search.v0.2"
ROUTE_SCHEMA_VERSION = "mga_route_genome.v0.2"
NODE_SCHEMA_VERSION = "mga_beam_node.v0.2"
