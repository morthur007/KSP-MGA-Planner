...
def _audit_route_worker(payload: Tuple[Dict[str, Any], Dict[str, Any]]) -> Dict[str, Any]:
    ...
    for j in range(len(legs) - 1):
        ...
        try:
            ...
            turn = angle_deg(v_inf_in_vec, v_inf_out_vec)
            # Turning angle is the angle between incoming and outgoing hyperbolic excess velocity vectors.
            # Do NOT negate v_inf_in here; negating it turns a near-straight flyby into ~180 deg.
...
def main() -> int:
    ...
    print("=" * 80)
    print("MGA FLYBY CLOSURE AUDIT V0.2")
    print("=" * 80)
