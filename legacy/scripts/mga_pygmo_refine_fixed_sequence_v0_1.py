#!/usr/bin/env python3
"""
mga_pygmo_refine_fixed_sequence_v0_1.py
...
Example
-------
  python mga_pygmo_refine_fixed_sequence_v0_1.py \
...
SCHEMA_VERSION = "mga_pygmo_refine_fixed_sequence.v0.1"
...
def print_report(routes: Sequence[RefinedRoute]) -> None:
    print("=" * 80)
    print("MGA PYGMO FIXED-SEQUENCE REFINER V0.1")
    print("=" * 80)
...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    ...
    parser.add_argument("--layover-max-days", type=float, default=1000.0, help="Absolute upper bound per flyby layover")
