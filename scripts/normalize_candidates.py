...
def main() -> int:
    ...
    for rank, row in enumerate(rows[: args.top_n], start=1):
        ...
        for i in range(1, len(bodies)):
            ...
            # Preserve exact Lambert seed velocities generated by PyKEP.
            # These are required by the native N-body leg optimizer.
            for suffix in [
                "vdep_x_km_s", "vdep_y_km_s", "vdep_z_km_s",
                "varr_x_km_s", "varr_y_km_s", "varr_z_km_s",
            ]:
                key = f"leg{i}_{suffix}"
                out[key] = row.get(key, "")
